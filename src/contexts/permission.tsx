...
const ROUTERS_PERMISSIONS: any = {
  home: [DESENVOLVEDOR, ADMINISTRADOR, ATENDENTE, COORDENADOR, COORDENADOR_TERAPEUTA],
  ...
  agenda: [DESENVOLVEDOR, ADMINISTRADOR, ATENDENTE, COORDENADOR, COORDENADOR_TERAPEUTA],
