  ...
  return (
   <Button 
    ...
    className={clsx(' text-white text-sm rounded-md border-none ' , { 
      ...
      'text-red-400 hover:text-violet-800 focus:text-violet-600': color === 'red',
      'text-green-400 hover:text-violet-800 focus:text-violet-600': color === 'green',
      'text-yellow-400 hover:text-violet-800 focus:text-violet-600': color === 'yellow',
      'text-violet-800 hover:text-violet-600 focus:text-violet-600': color === 'violet',
