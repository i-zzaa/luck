...
export const api = axios.create({
  baseURL: 'https://lfzqax.hospedagemelastica.com.br', //import.meta.env.VITE_API_URL, //import.meta.env.VITE_API_URL || process.env.VITE_API_URL, //'https://api-multialcance.online', //
  headers: {
