...
export const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL, //, 'https://api-multialcance.online', // import.meta.env.VITE_API_URL || process.env.VITE_API_URL,  import.meta.env.VITE_API_URL || process.env.VITE_API_URL, //
  headers: {
