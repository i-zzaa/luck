...
export const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL, // 'https://lfzqax.hospedagemelastica.com.br', //import.meta.env.VITE_API_URL, //import.meta.env.VITE_API_URL || process.env.VITE_API_URL, //'https://api-multialcance.online', //
  headers: {
